...
func TestDefaultRules(t *testing.T) {
	...
	rules := DefaultRules(map[string]string{"kubernetes_yum_version": "1.9.1-0", "kubernetes_deb_version": "1.9.1-00"})
	if len(rules) != 79 {
...
func TestUpgradeRules(t *testing.T) {
	...
	rules := UpgradeRules(map[string]string{"kubernetes_yum_version": "1.9.1-0", "kubernetes_deb_version": "1.9.1-00"})
	if len(rules) != 16 {
